...
### PresignedURL Arguments
1. **operanionName:** Name of the operation the presignedURL is being created for
2. **params:**
   -  ***Bucket:*** Name of the bucket we're uploading to
   -  ***Key:*** Name of the file being uploaded
   -  ***ContentType:*** Content Type of the file that will be getting uploaded.
